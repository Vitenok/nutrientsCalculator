...
<body>
    <div class="container margin-top-10">
        ...
        <div data-ng-controller="nutrientsCalcCtrl">
                    ...
                    <table class="table table-hover  table-fixed">
                        ...
                        <tr data-ng-repeat="product in products">
                            ...
                            <td class="col-md-1">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" ng-model="selected[product.itemName]" ng-click="getSelected()">
                                    </label>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="col-md-7">
                    ...
                    <div>
                        <button type="button" class="btn btn-info btn-lg centered " ng-class="{disabled: isDisabledButton}">
                            Calculate
                        </button>
                    </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('nutrientsCalcCtrl', function($scope, $http){
            $scope.selected = {};
